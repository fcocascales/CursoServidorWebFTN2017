...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo $raiz ?>backend/favicon.ico" type="image/x-icon">
    ...
    <header id="pageheader">
      <section id="super">
        ...
        <div id="user">
          ...
          <a href="<?php echo $raiz ?>backend/logout.php">Desconectar <i class="fa fa-power-off"></i></a>
        </div>
      </section>
      <?php
      ...
      <nav id="navigator">
        ...
        <ul>
          ...
          <li><a href="<?php echo $raiz ?>backend/carrusel/">Carrusel</a></li>
