<?php // ficha.php
  ...
  $title = "$ficha[producto] - Thor";
  $keywords = "thor, ficha, producto, comida, catálogo";
  $description = "Ficha del producto"; // 150 carácteres
  $extra = '';
  $include = '';
  ...
  echo '<h1>'.htmlspecialchars($ficha['producto']).'</h1>';
