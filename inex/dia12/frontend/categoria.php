...
<form id="filtrar" method="get" class="filtro">
  ...
  <p>
    ...
    <select id="precio" name="precio">
      ...
      <?php imprimirFormOpciones($listaPrecio, $rangoPrecio) ?>
    </select>
  </p>
  <p>
    ...
    <select id="proveedor" name="proveedor">
      ...
      <?php imprimirFormOpciones(obtenerProveedoresPorCategoria($idCategoria), $idProveedor) ?>
    </select>
  </p>
  <p>
    <label for="ordenar">Ordenar:</label>
    <select id="ordenar" name="ordenar">
      <?php imprimirFormOpciones($listaOrdenar, $ordenacion) ?>
    </select>
  </p>
  <p>
